      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <motion.div variants={fadeInUp}>
            <SpotlightCard className="p-8 h-full group" spotlightColor="rgba(139, 92, 246, 0.06)">
              <div className="flex items-center gap-3 mb-1">
                <div className="p-2.5 rounded-xl bg-violet-500/10 border border-violet-500/20 group-hover:border-violet-500/40 transition-colors">
              ...
              <p className="text-muted text-sm mb-6">
                Fill in the form and I&apos;ll reply at{" "}
                <span className="text-white font-mono">vimalraj07145@gmail.com</span>
              </p>
              <ContactForm />
            </SpotlightCard>
          </motion.div>
